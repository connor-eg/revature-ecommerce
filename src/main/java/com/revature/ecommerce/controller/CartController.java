...
public class CartController {
    ...
    @DeleteMapping("/")
    public ResponseEntity<String> removeItemFromCart(@RequestHeader String token, @RequestHeader long itemId) throws SessionTokenInvalidException{
        return productOrderService.removeCartItem(token, itemId);
    }
